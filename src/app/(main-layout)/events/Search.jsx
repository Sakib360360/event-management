        ...
        {filteredEvents.map((event) => (
          ...
          >
            ...
            <div className="flex justify-between items-center">
              <button className="bg-[#55c2da] text-white p-2 rounded-md hover:bg-[#55c2da]">
                Details
              </button>
              <div className="flex">
                <button className="bg-blue-500 text-white p-2 mr-4 rounded-md hover:bg-blue-600">
                  Buy
                </button>
                <div className="">
              <button
                className="bg-blue-500 flex gap-1 justify-between items-center mr-4 text-white p-2 rounded-md hover:bg-blue-600"
            ...
            {selectedEventId === event._id && (
              <div className="flex gap-2 justify-between items-center">
                ...
                <FaHeart
                  color="red"
                  className="favoriteIcon cursor-pointer ml-2 mt-1"
                  size={30}
                />
              </div>
            </div>
