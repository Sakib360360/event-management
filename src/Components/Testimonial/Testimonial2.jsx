...
const Testimonial2 = () => {
  ...
  return (
    <section className="container mx-auto my-[7em]">
      <h4 className="text-[1.5rem] md:text-[1.5rem] font-bold mb-4">WHAT OTHERS SAY</h4>
            ...
            >
              <div className="">
                ...
                <div className="card-body">
                  <p className="text-[18px]">{testimonial.content}</p>
                  <div className="flex justify-between items-center mt-4">
                    <div>
                      <h2 className="text-white font-medium text-[16px]">
                        {" "}
                        <span className="text-blue-500"> @ </span> {testimonial.author}
                      </h2>
